    ...
    <section class="page-container">
        <div class="tableDivs">
            ...
            >
                ...
                >
                    <template slot-scope="scope">
                        {{ filterNumber(scope.row.buy_fixed_rate) }}
                    </template>
                </el-table-column>
                <el-table-column
                ...
                >
                    <template slot-scope="scope">
                        {{ filterNumber(scope.row.sell_fixed_rate) }}
                    </template>
                </el-table-column>
                <el-table-column
        ...
        >
            <el-form :model="edit" ref="edit" :rules="rules">
                ...
                <el-form-item
                        ...
                        :label-width="formLabelWidth"
                >
                    <el-input v-model="edit.buy_fixed_rate" placeholder="代收固定费率"></el-input>
                </el-form-item>
                <el-form-item
                        prop="buy_specify_type"
                        label="代收指派类型"
                ...
                <el-form-item
                        ...
                        :label-width="formLabelWidth"
                >
                    <el-input v-model="edit.sell_fixed_rate" placeholder="代付固定费率"></el-input>
                </el-form-item>
